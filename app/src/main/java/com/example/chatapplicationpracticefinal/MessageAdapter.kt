...
import com.example.chatapplicationpracticefinal.databinding.ReceiverLayoutItemBinding
import com.example.chatapplicationpracticefinal.databinding.SentItemLayoutBinding
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
         ...
         if(viewType==ITEM_SENT) {
           return SentViewHolder(LayoutInflater.from(context).inflate(R.layout.sent_item_layout,parent,false))
             ...
             return  ReceiverViewHolder(LayoutInflater.from(context).inflate(R.layout.receiver_layout_item,parent,false))
        }
    }
